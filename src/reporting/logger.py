...
class SimulationLogger:
    ...
    def log(
        ...
        baseline_load_kw: float = 0.0,
        current_load_kw: float = 0.0,
        peak_load_kw: float = 0.0,
        total_energy_kwh: float = 0.0,
        comfort_loss_degree_minutes: float = 0.0,
        demand_response_active: bool = False,
        demand_response_target_kw: float = 0.0,
        demand_response_actual_kw: float = 0.0,
        demand_response_failure_rate: float = 0.0,
        compromised_load_kw: float = 0.0,
        protected_load_kw: float = 0.0,
        pre_event_average_load_kw: float = 0.0,
        event_average_load_kw: float = 0.0,
        baseline_event_average_load_kw: float = 0.0,
        demand_response_target_reduction_kw: float = 0.0,
        demand_response_actual_reduction_kw: float = 0.0,
        demand_response_achievement_rate: float = 0.0,
        compromised_devices_count: int = 0,
        total_load_kw: float = 0.0,
        load_spike_kw_from_compromised_devices: float = 0.0,
    ) -> dict:
        entry = {
            ...
            "comfort_loss_degree_minutes": comfort_loss_degree_minutes,
            "demand_response_active": demand_response_active,
            "demand_response_target_kw": demand_response_target_kw,
            "demand_response_actual_kw": demand_response_actual_kw,
            "demand_response_failure_rate": demand_response_failure_rate,
            "compromised_load_kw": compromised_load_kw,
            "protected_load_kw": protected_load_kw,
            "pre_event_average_load_kw": pre_event_average_load_kw,
            "event_average_load_kw": event_average_load_kw,
            "baseline_event_average_load_kw": baseline_event_average_load_kw,
            "demand_response_target_reduction_kw": demand_response_target_reduction_kw,
            "demand_response_actual_reduction_kw": demand_response_actual_reduction_kw,
            "demand_response_achievement_rate": demand_response_achievement_rate,
            "compromised_devices_count": compromised_devices_count,
            "total_load_kw": total_load_kw,
            "load_spike_kw_from_compromised_devices": load_spike_kw_from_compromised_devices,
        }
